...
class BasePollForm(ModelForm):
    class Meta:
        model = VotingPoll
        fields = ['title','description','closing_date','preference_model','option_choice','option_modify','option_shuffle','status_poll','option_blocking_poll','winner_poll']
        widgets = {
            ...
            'winner-poll': forms.IntegerField(widget=forms.NumberInput),
...
class OptionForm(ModelForm):
    ...
    class Meta(BasePollForm.Meta):
        fields = ['closing_date','option_choice', 'option_modify','option_shuffle','option_blocking_poll', 'winner_poll']
